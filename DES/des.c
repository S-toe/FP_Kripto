...
void generate_key_file(const char *key){
...
void writeData(){
	unsigned char* num = "1234,123441212";
	FILE *fptr;
...
int des_enc(const char * input, const char * output,unsigned char* keyS) {
	clock_t start, finish;
	double time_taken;
	unsigned long file_size;
	unsigned short int padding;
...
int des_dec(const char * input, const char * output,unsigned char* keyS) {
	clock_t start, finish;
	double time_taken;
	unsigned long file_size;
	unsigned short int padding;
...
char* des_dec_to_s(const char * input,unsigned char* keyS) {
